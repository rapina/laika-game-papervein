...
- Murr의 공개 평가와 640/1280 이미지가 포함된 아케이드 커밋 `50fe1e7c0903a63b4984898985ebed9299825751`이 production 배포 `https://laika-7pkc4d6m8-rapinas-projects.vercel.app`에 성공했다. 이 불변 배포 주소는 보호 설정 때문에 무인 스모크의 catalog 요청에 401을 반환했다.
- 같은 커밋을 제공하는 운영 URL에서 다시 실제 포인터 완주했다: `66.184657초`, 7/7 봉합, 파열 1, 콘솔·페이지·요청 오류 0. 공개 catalog의 `earthReview.playedArtifactVersion`과 artifact version이 일치했고, Murr 640/1280 이미지와 플레이 URL은 모두 HTTP 200이었다.
